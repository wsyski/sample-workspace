...
public class CommonServicesConstants {
    ...
    public static final String KEY_FEDERATED_SEARCH_CUSTOMER_ID = "federatedSearchCustomerId";
    public static final String KEY_FEDERATED_SEARCH_SOURCE_CONFIG = "federatedSearchSourceConfig";
    public static final String KEY_OPENING_HOURS_CUSTOMER_ID = "openingHoursCustomerId";
    public static final String KEY_TRANSACTION_TENANT_ID = "transactionTenantId";
    ...
    public static final String HEADER_CACHE_CONTROL_VALUE = "public, max-age=" + String.valueOf(CACHE_EXPIRATION_TIME);
}
