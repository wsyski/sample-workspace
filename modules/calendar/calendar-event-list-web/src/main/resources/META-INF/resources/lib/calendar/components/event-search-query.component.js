...
var EventSearchQueryComponent = /** @class */ (function () {
    function EventSearchQueryComponent(store) {
        this.store = store;
    }
    EventSearchQueryComponent.prototype.onClear = function () {
        this.value = '';
        this.search();
    };
    EventSearchQueryComponent.prototype.isClearButtonVisible = function () {
        return !!this.value;
    };
    EventSearchQueryComponent.prototype.search = function () {
        this.store.dispatch(new SearchActions.Search({ 'query': { q: this.value } }));
    };
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], EventSearchQueryComponent.prototype, "value", void 0);
    EventSearchQueryComponent = __decorate([
        core_1.Component({
    ...
    return EventSearchQueryComponent;
}());
exports.EventSearchQueryComponent = EventSearchQueryComponent;
//# sourceMappingURL=event-search-query.component.js.map